...
-- GENERAL --
Config.MenuTitle = 'OXYDE' -- changez-le en votre nom de serveur
Config.DoubleJob = true -- activer si vous utilisez esx double job
Config.NoclipSpeed = 1.0 -- changez-le pour changer la vitesse dans noclip
Config.JSFourIDCard = true -- activer si vous utilisez jsfour-idcard
